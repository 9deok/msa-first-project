...
public class RestaurantApprovalRequestAvroModel extends
    ...
    public static BinaryMessageDecoder<RestaurantApprovalRequestAvroModel> createDecoder(
        ...
        return new BinaryMessageDecoder<RestaurantApprovalRequestAvroModel>(MODEL$, SCHEMA$,
            resolver);
    }
     ...
     */
    public RestaurantApprovalRequestAvroModel(String id, String sagaId, String restaurantId,
        String orderId, RestaurantOrderStatus restaurantOrderStatus,
        java.util.List<Product> products, java.math.BigDecimal price, java.time.Instant createdAt) {
        this.id = id;
        this.sagaId = sagaId;
    ...
    public static class Builder extends
        org.apache.avro.specific.SpecificRecordBuilderBase<RestaurantApprovalRequestAvroModel>
        ...
        private Builder(Builder other) {
            ...
            if (isValidValue(fields()[4], other.restaurantOrderStatus)) {
                this.restaurantOrderStatus = data().deepCopy(fields()[4].schema(),
                    other.restaurantOrderStatus);
        ...
        public RestaurantApprovalRequestAvroModel build() {
            try {
                ...
                record.sagaId =
                    fieldSetFlags()[1] ? this.sagaId : (String) defaultValue(fields()[1]);
                record.restaurantId =
                    fieldSetFlags()[2] ? this.restaurantId : (String) defaultValue(fields()[2]);
                record.orderId =
                    fieldSetFlags()[3] ? this.orderId : (String) defaultValue(fields()[3]);
                record.restaurantOrderStatus = fieldSetFlags()[4] ? this.restaurantOrderStatus
                    : (RestaurantOrderStatus) defaultValue(fields()[4]);
                record.products = fieldSetFlags()[5] ? this.products
                    : (java.util.List<Product>) defaultValue(fields()[5]);
                record.price = fieldSetFlags()[6] ? this.price
                    : (java.math.BigDecimal) defaultValue(fields()[6]);
                record.createdAt = fieldSetFlags()[7] ? this.createdAt
                    : (java.time.Instant) defaultValue(fields()[7]);
                return record;
    ...
    private static final org.apache.avro.io.DatumWriter<RestaurantApprovalRequestAvroModel>
        WRITER$ = (org.apache.avro.io.DatumWriter<RestaurantApprovalRequestAvroModel>) MODEL$.createDatumWriter(
        SCHEMA$);
    ...
    private static final org.apache.avro.io.DatumReader<RestaurantApprovalRequestAvroModel>
        READER$ = (org.apache.avro.io.DatumReader<RestaurantApprovalRequestAvroModel>) MODEL$.createDatumReader(
        SCHEMA$);
