...
public class RestaurantApprovalResponseAvroModel extends
    ...
    public static BinaryMessageDecoder<RestaurantApprovalResponseAvroModel> createDecoder(
        ...
        return new BinaryMessageDecoder<RestaurantApprovalResponseAvroModel>(MODEL$, SCHEMA$,
            resolver);
    }
     ...
     */
    public RestaurantApprovalResponseAvroModel(String id, String sagaId, String restaurantId,
        String orderId, java.time.Instant createdAt, OrderApprovalStatus orderApprovalStatus,
    ...
    public static class Builder extends
        org.apache.avro.specific.SpecificRecordBuilderBase<RestaurantApprovalResponseAvroModel>
        ...
        private Builder(Builder other) {
            ...
            if (isValidValue(fields()[5], other.orderApprovalStatus)) {
                this.orderApprovalStatus = data().deepCopy(fields()[5].schema(),
                    other.orderApprovalStatus);
        ...
        public RestaurantApprovalResponseAvroModel build() {
            try {
                ...
                record.createdAt = fieldSetFlags()[4] ? this.createdAt
    ...
    private static final org.apache.avro.io.DatumWriter<RestaurantApprovalResponseAvroModel>
        WRITER$ = (org.apache.avro.io.DatumWriter<RestaurantApprovalResponseAvroModel>) MODEL$.createDatumWriter(
        SCHEMA$);
    ...
    private static final org.apache.avro.io.DatumReader<RestaurantApprovalResponseAvroModel>
        READER$ = (org.apache.avro.io.DatumReader<RestaurantApprovalResponseAvroModel>) MODEL$.createDatumReader(
        SCHEMA$);
