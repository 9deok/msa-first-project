...
public class PaymentResponseAvroModel extends org.apache.avro.specific.SpecificRecordBase implements
     ...
     */
    public static BinaryMessageDecoder<PaymentResponseAvroModel> createDecoder(
     ...
     */
    public PaymentResponseAvroModel(String id, String sagaId, String paymentId, String customerId,
        String orderId, java.math.BigDecimal price, java.time.Instant createdAt,
        PaymentStatus paymentStatus, java.util.List<String> failureMessages) {
        this.id = id;
        this.sagaId = sagaId;
    ...
    public static class Builder extends
        ...
        public PaymentResponseAvroModel build() {
            try {
                ...
                record.paymentId =
                    fieldSetFlags()[2] ? this.paymentId : (String) defaultValue(fields()[2]);
                record.customerId =
                    fieldSetFlags()[3] ? this.customerId : (String) defaultValue(fields()[3]);
                record.orderId =
                    fieldSetFlags()[4] ? this.orderId : (String) defaultValue(fields()[4]);
                record.price = fieldSetFlags()[5] ? this.price
                    : (java.math.BigDecimal) defaultValue(fields()[5]);
                record.createdAt = fieldSetFlags()[6] ? this.createdAt
                    : (java.time.Instant) defaultValue(fields()[6]);
                record.paymentStatus = fieldSetFlags()[7] ? this.paymentStatus
                    : (PaymentStatus) defaultValue(fields()[7]);
