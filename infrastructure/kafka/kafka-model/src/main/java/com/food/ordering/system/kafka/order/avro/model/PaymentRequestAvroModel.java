...
public class PaymentRequestAvroModel extends org.apache.avro.specific.SpecificRecordBase implements
     ...
     */
    public static BinaryMessageDecoder<PaymentRequestAvroModel> createDecoder(
     ...
     */
    public PaymentRequestAvroModel(String id, String sagaId, String customerId, String orderId,
    ...
    public static class Builder extends
        ...
        private Builder(Builder other) {
            ...
            if (isValidValue(fields()[6], other.paymentOrderStatus)) {
                this.paymentOrderStatus = data().deepCopy(fields()[6].schema(),
                    other.paymentOrderStatus);
        ...
        public PaymentRequestAvroModel build() {
            try {
                ...
                record.price = fieldSetFlags()[4] ? this.price
                    : (java.math.BigDecimal) defaultValue(fields()[4]);
                record.createdAt = fieldSetFlags()[5] ? this.createdAt
                    : (java.time.Instant) defaultValue(fields()[5]);
